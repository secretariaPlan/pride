...
//Para logearse con el pwd maestro, solo difiete en q el control se llama con un par adicional tipo=m
...
function getlog()
		{
			...
			ipwd = hex_sha1(pwd);
			window.location = "LoginCtrl.php?usuario="+usuario+"&pwd="+ipwd+"&tipo=m";
      ...
      <table width="95%" border="0" align="center" cellpadding="3" cellspacing="1">
        <tr> 
          <td width="64%" class="tituloama30"><div align="center"> 
              <p class="tituloazul24">Sistema de Informaci&oacute;n Curricular 
                <br>
                del Personal Acad&eacute;mico</p>
            </div></td>
        </tr>
        <tr> 
          <td class="renglonazul"><div align="center">Ingrese su usuario y contrase&ntilde;a 
              para entrar a SICPA</div></td>
        </tr>
        <tr> 
          <td class="backgris">
              ...
              <table width="90%" border="0" align="center" cellpadding="3" cellspacing="2">
                ...
                <tr> 
                  ...
                  <td class="ligarojo11"> <a href="olvide.php">Olvid&eacute; mi 
                    contrase&ntilde;a &raquo;</a>&nbsp;&nbsp;&nbsp; <a href="cambiarpwd.php">Cambiar contraseña &raquo;</a> </td>
                </tr>
                <tr> 
                  <td>&nbsp;</td>
                  <td><div align="center"> 
                      <input type="submit" name="Submit" value="Entrar a SICPA">
                    </div></td>
                  <td>&nbsp;</td>
                </tr>
              </table>
