		...
		<div class="col_4">
			<div class="center">
				...
				<div class="notice error" id="mensaje1" style="display: none;">
					<i class="fa fa-remove fa-large"></i> Correo Electronico no valido
					<a href="#close" class="fa fa-remove"></a>
				</div>


				<div class="notice error" id="mensaje2" style="display: none;">
					<i class="fa fa-remove fa-large"></i> Repita el Correo Electronico
					<a href="#close" class="fa fa-remove"></a>
				</div>
...
<script type="text/javascript"
	src="<?php echo base_url()?>js/recovery_pass.js"></script>