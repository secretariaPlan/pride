...
<div class="page-content">
            ...
            <div class="col-xs-12">
                ...
                <form id="formulario" name="form1" method="post">
                                ...
                                <select class="full-width" id="estado" onchange="buscar_cidades();" name="estado">
                                    ...
                                    <?php
                                        ...
                                        foreach ($estados as $e):
                                            $selected = $e->id_estado == $alunos->id_estado ? "selected" : "";
                                            ?>
                        ...
                        <div class="col-xs-5">
                            <div>
                                <select class="full-width" id="load_cidades" name="id_municipio_aluno">
                                        ...
                                        <option value="<?php echo $alunos->id_municipio_aluno; ?>">
                                           <?php echo $alunos->nome_municipio; ?>
                                        </option>
                                </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            <input type="text" name="registro_matricula" value="<?php echo set_value('registro_matricula') ? set_value('registro_matricula') : $alunos->registro_matricula; ?>" class="full-width">
                        </div>
                        <div class="col-xs-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            <input type="text"  name="nome_aluno"  value="<?php echo set_value('nome_aluno') ? set_value('nome_aluno') : $alunos->nome_aluno; ?>"  class="full-width">
                        </div>
                        <div class="col-xs-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            <input type="text" name="nome_mae"  value="<?php echo set_value('nome_mae') ? set_value('nome_mae') : $alunos->nome_mae; ?>"  class="full-width">
                        </div>
                        <div class="col-xs-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            <input type="text"  name="nome_pai"  value="<?php echo set_value('nome_pai') ? set_value('nome_pai') : $alunos->nome_pai; ?>"  class="full-width">
                        </div>
                        <div class="col-xs-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            <input type="date" name="data_nascimento" value="<?php echo set_value('data_nascimento') ? set_value('data_nascimento') : $alunos->data_nascimento; ?>" required class="full-width">
                        </div>
                        <div class="col-xs-1">
    ...
    <?php }?>
           <div class="col-xs-12">
                <a href='<?php echo base_url().'aluno/listar' ?>'><button class="btn btn-success">Voltar</button></a>
         </div> 
        </div><!-- /.col -->
