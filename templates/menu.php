...
<table border="0" cellpadding="0" cellspacing="0" background="imagenes/backgris.gif">
  	...
  	<td colspan="2" >
		 ...
		 switch($mesAhora)
		{
			case 1:
				?> 
					<div align="center">
  					<a href="informeEstado.php"><img src="imagenes/Enviar.gif" width="110" height="30" ></a>
  					</div>
				<?
			break;
			//case 9:
    ...
    <td colspan="2" class="ligamenuleft1"><strong><img src="imagenes/iconos/participa.gif" width="13" height="14"> 
      ...
      <div id="menu2">
    	...
    	<tr> 
  		...
  		<tr> 
    		<td>&nbsp;</td>
    		<td class="ligamenuleft">&#8226; <a href="pi_revisiones.php">Revisiones técnicas</a></td>
  		</tr>
  		<tr> 
    		<td>&nbsp;</td>
    ...
    <td colspan="2" class="ligamenuleft1"><strong><img src="imagenes/iconos/docencia.gif" width="13" height="15"> 
      ...
      <div id="menu3">
    	...
    	<td>&nbsp;</td>
  		...
  		<tr> 
    	<td>&nbsp;</td>
    		<td class="ligamenuleft">&#8226; <a href="docencia_proyectos.php">Proyectos financiados por el PAPIME</a></td>
  		</tr>
  		<tr> 
    		<td>&nbsp;</td>
  ...
  <tr> 
    <td colspan="2"><strong><img src="imagenes/botgris.gif" width="110" height="37"></strong></td>
  </tr>
</table>
